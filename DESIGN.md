...
- **Text:** `#0E0E0E` — 深近黑，主文字
- **Text-secondary:** `#111111` — 次级深色，hover/激活态文字
...
- **圆角:** 默认 `rounded-xl`（12px）；`rounded-full`（胶囊）用于按钮、徽章、标签、装饰点——不要直角
...
> 本节约束 **AI 衍生产出**（封面/PPT/视频/原型）。网站源体作为审美锚定物，✦ 可密集使用作为视觉 DNA，不受「不当装饰撒」限制。
